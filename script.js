...
let flappyScore = 0;
let flappyGravity = 0.0040; // 大幅降低重力效果 (再降低10倍)
...
const messageContents = [
  {
    id: 1,
    title: "睿謙的生日祝福",
    text: "給涵篔\n生日快樂！祝你新的一歲能吃飽睡好、過的天天開心、學業順利\n你是最可愛⋯的（？",
  },
  {
    id: 2,
    title: "雅若的生日祝福",
    text: "我的好室友蔡涵篔生日快樂🎂\n希望你22歲生日這年，我們也可以常常一起遇到快樂的事，遇到很好的人，吃到很多好吃的食物，睡得很飽，去很多好玩的地方\n\nBy你的好室友陳雅若 誒嘿嘿嘿愛你💖",
  },
  {
    id: 3,
    title: "孟桓的生日祝福",
    text: "To:蔡涵篔\n時間過好快！認識以來的一年多，謝謝你帶來的快樂，以及生活課業上的幫助，覺得自己很幸運作為你的朋友哈哈，未來還請多關照（？\n\n最後⋯\n生日快樂！\n\n（抱歉卡片消失了好好笑，但沒關係那個裡面有點假掰（沒，這裡就平鋪直述一點，如果找到再給你哈哈）\n\n祝 吃飽睡好 天天快樂！\n\n2025.4.18  by:糠",
  },
  {
    id: 4,
    title: "我的生日祝福",
    text: "給篔姐~\n\n不知道妳在看到這個網站與卡片的時候，是正在準備免疫段考熬夜中呢？還是已經結束了一天的行程終於可以好好休息、或是根本已經睡到隔天下午了（我猜大概率是這個😂）\n但不論妳是何時看到的都沒關係，因為我對妳的祝福是不會過期的！畢竟，我本來就有365個理由希望妳天天都過得開心快樂，生日快樂，就只是在這個特別的日子裡，送上與每天一樣的，一個真摯但平凡的祝福罷了。\n\n不過雖然心意都是一樣的，但有些真心的話還是需要在這個特別的日子傳達。\n我想對妳說，謝謝妳沒有因為對我的第一印象不好，而讓我失去了能與妳變熟的機會，雖然我們個性真的很不一樣，但妳時而細心周到、時而內斂可靠、時而活潑可愛的多種樣貌，都讓我欣賞與好奇，而日常與妳相處的點滴，或是一同出遊與吃飯時的輕鬆愉快，也都讓我更珍惜這段特別的緣分，能夠跟「另一個世界」的妳當朋友，讓我真心的感到幸運！我也由衷的祝福妳在未來這一年健康快樂、心想事成！有什麼需要幫忙的地方，我也會一直都在！\n\n最後來講一下禮物！我覺得我還是太不了解妳了🥺除了五月天我實在不知道妳還有什麼特別的嗜好，妳的優秀獨立也讓我找不到需求下手，總不能送妳考古題對吧（X），但我還是很希望能將心意好好傳達，所以陸陸續續花了一個月的時間製作生日網站跟貼圖作為禮物，雖然不貴重也沒有實體，但還是希望這兩個有點特別的禮物，能夠讓妳喜歡與感動！而最後一個神秘禮物，就等之後再告訴妳了~敬請期待吧！\n\n再次祝妳生日快樂！\n方旭誠 上",
  },
];
